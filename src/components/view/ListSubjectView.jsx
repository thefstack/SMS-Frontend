...
const ListView = (props) => {
  const { isLoading, setIsAdding, removeSubject, isError,isAdding} = useSubjectContext();
  ...
  const handleConfirm = (res) => {
    if (res && subjectIdToRemove !== null) {
      removeSubject(subjectIdToRemove);
    }
            ...
            {props.data.map((subject) => (
              <tr key={subject.id}>
                ...
                <td className="view-x-btn">
                  <Link to={`/admin/subject/${subject.id}`} className="view-btn">View</Link>
                  <button
                    style={{ backgroundColor: "red" }}
                    className="view-btn"
                    onClick={() => confirmRemoveSubject(subject.id)}
                  >
                    X
                  </button>
                </td>
