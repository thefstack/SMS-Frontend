...
const AddStudent = () => {
  const {isLoading,setIsAdding,addStudent, isAdded}=useStudentContext()
  ...
  const [formData, setFormData] = useState({
    ...
    monthly_fee:0,
    status:'Active',
    date_of_status:new Date().toISOString().slice(0, 10), // get date in the format "YYYY-MM-DD"
    class:''
  });
  ...
  const handleSubmit=async(e)=>{
    ...
    if (!formData.monthly_fee) newErrors.monthly_fee = 'Monthly Fee is required';
